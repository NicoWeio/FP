...
% that are produced by this stimulated emission of a single passing photon,
The proportion of
...
Due to the shape of the diode, the resulting light beam is strongly divergent and is therefore collimated with the help of a lens.
...
% NOTE: free mobility → nearly continuous energy levels
...
All other wavelengths are scattered by the grating without constructive interference. % TODO: right?
