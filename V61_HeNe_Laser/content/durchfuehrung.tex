...
\label{sec:versuchsaufbau}
    ...
    Der Grundaufbau besteht aus einer optischen Bank, %TODO
...
\subsubsection{Die transversalen Moden}
    ...
    % TODO: Revert ↑ (und anderswo…)
    Dazu werden zwischen Resonatorspiegel und Photodiode eine Vergrößerungslinse und eine Blende eingebaut,
    welche um \SI{10}{\milli\meter} vor und zurück verschoben werden können.\\ %TODO: Richtig?
    ...
    % TODO: Muss? Waren das nicht einfach unsere Messwerte?
    ...
    \\
    % TODO: Verschieben in den zugehörigen Abschnitt? ↓
