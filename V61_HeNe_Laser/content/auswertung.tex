...
deren Parameter mithilfe von \texttt{scipy.optimize.curve\_fit} an die Messwerte angepasst werden.
...
% \begin{description}
%   \item[$I_\text{max}$] maximale Intensität
%   \item[$I_0$] Hintergrund, beispielsweise durch Streulicht
%   \item[$r_0$] Mittelpunkt des Laserstrahls % bzw. Verschiebung von Strahlachse
%   \item[$ω$] Breite der Gauß-Verteilung
% \end{description}
...
Das Anpassen der Parameter an die Messwerte erfolgt erneut mit \texttt{scipy.optimize.curve\_fit}.
