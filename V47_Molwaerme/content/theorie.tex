...
\label{sec:theorie:debye}
    ...
    Die zugehörige Debye-Temperatur ist definiert als
    \begin{equation}
    ...
    \begin{figure}
        \centering
        % TODO: Die PDFs sind unterschiedlich hoch. Die Angabe von `height` ist eher ein Workaround.
