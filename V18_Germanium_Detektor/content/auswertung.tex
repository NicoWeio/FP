...
% TODO: Diesen Teil der Aufgabenstellung können wir nicht sinnvoll erledigen,
% ohne wie @Imigir Regressionsgeraden an die Peaks zu fitten.
% > Prüfen Sie, ob die gemessene Halbwertsbreite der Photolinie mit der Zehntelwertsbreite konsistent ist.
% > (Welcher Zusammenhang gilt zwischen diesen beiden Größen für eine Gaußverteilung?)

% TODO: Position der Compton-Kante
