...
% NOTE: Natürlich verringern längere Messdauern den relativen Poisson-Fehler,
%       aber der Wert von 20 Stunden ist nicht begründet – es gibt keine Ex-Ante-Schätzung für die Stopp-Ereignisse.
% Diese sollte eine Dauer von mindestens \SI{20}{\hour} umfassen,
% um einen ausreichend geringen relativen Poisson-Fehler zu erhalten.
