...
Indem die magnetische Flussdichte aus \autoref{eqn:zeemanaufspaltung} %TODO: richtige Gleichung verlinkt?
...
\begin{align*}
    ...
    % \Leftrightarrow
    % B &= \frac{\symup{\Delta} E_\text{Z}}{g_F \mu_\text{B} \symup{\Delta} m_J}
    \Rightarrow
