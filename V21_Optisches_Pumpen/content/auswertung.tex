...
\label{sec:auswertung:B_erd_vert}
...
\end{equation*}
berechnet werden.
% ↑ Kann man bestimmt, aber nachgerechnet habe ich das nicht.
...
\label{sec:auswertung:isotopenverhaeltnis}
...
\label{sec:auswertung:quad_zeeman}
