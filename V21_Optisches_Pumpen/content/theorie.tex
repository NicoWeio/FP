...
\label{sec:theorie:energieaufspaltung}
...
\subsection{Quadratischer Zeeman-Effekt}
    ...
    Abhängig von der Feldstärke des angelegten Magnetfelds werden weitere Terme des Hamilton-Operators für die Energieaufspaltung beim Zeeman-Effekt relevant.
...
\label{sec:theorie:optisches_pumpen}
    ...
    wenn das einfallende Licht mit der Energiedifferenz und den in \autoref{sec:theorie:energieaufspaltung} genannten Auswahlregeln kompatibel ist.
    Aufgrund dessen entsteht eine Besetzungsinversion im Atom.
